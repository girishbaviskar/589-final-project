...
\begin{center}
    \begin{Large}
    COMPSCI 589 - Final Project - Spring 2023
    \end{Large}
    \\
    \HIGHLIGHT{Due May 17, 2023, 11:55 pm Eastern Time}
\end{center}
...
\begin{itemize}
    ...
    \item The tex file for this assignment (which you can use if you decide to write your solution in \LaTeX), as well as the datasets, can be found \href{https://people.cs.umass.edu/~bsilva/courses/CMPSCI_589/Spring2023/homeworks/final_project.zip}{here}.
    \item The automated system will not accept assignments after 11:55pm on May 17. 
